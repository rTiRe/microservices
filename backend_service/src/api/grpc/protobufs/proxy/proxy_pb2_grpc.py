...
class CentrifugoProxyStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Connect = channel.unary_unary(
                ...
                request_serializer=proxy__pb2.ConnectRequest.SerializeToString,
                response_deserializer=proxy__pb2.ConnectResponse.FromString,
                _registered_method=True)
        self.Refresh = channel.unary_unary(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/Refresh',
                request_serializer=proxy__pb2.RefreshRequest.SerializeToString,
                response_deserializer=proxy__pb2.RefreshResponse.FromString,
                _registered_method=True)
        self.Subscribe = channel.unary_unary(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/Subscribe',
                request_serializer=proxy__pb2.SubscribeRequest.SerializeToString,
                response_deserializer=proxy__pb2.SubscribeResponse.FromString,
                _registered_method=True)
        self.Publish = channel.unary_unary(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/Publish',
                request_serializer=proxy__pb2.PublishRequest.SerializeToString,
                response_deserializer=proxy__pb2.PublishResponse.FromString,
                _registered_method=True)
        self.RPC = channel.unary_unary(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/RPC',
                request_serializer=proxy__pb2.RPCRequest.SerializeToString,
                response_deserializer=proxy__pb2.RPCResponse.FromString,
                _registered_method=True)
        self.SubRefresh = channel.unary_unary(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/SubRefresh',
                request_serializer=proxy__pb2.SubRefreshRequest.SerializeToString,
                response_deserializer=proxy__pb2.SubRefreshResponse.FromString,
                _registered_method=True)
        self.SubscribeUnidirectional = channel.unary_stream(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/SubscribeUnidirectional',
                request_serializer=proxy__pb2.SubscribeRequest.SerializeToString,
                response_deserializer=proxy__pb2.StreamSubscribeResponse.FromString,
                _registered_method=True)
        self.SubscribeBidirectional = channel.stream_stream(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/SubscribeBidirectional',
                request_serializer=proxy__pb2.StreamSubscribeRequest.SerializeToString,
                response_deserializer=proxy__pb2.StreamSubscribeResponse.FromString,
                _registered_method=True)
        self.NotifyCacheEmpty = channel.unary_unary(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/NotifyCacheEmpty',
                request_serializer=proxy__pb2.NotifyCacheEmptyRequest.SerializeToString,
                response_deserializer=proxy__pb2.NotifyCacheEmptyResponse.FromString,
                _registered_method=True)
        self.NotifyChannelState = channel.unary_unary(
                '/centrifugal.centrifugo.proxy.CentrifugoProxy/NotifyChannelState',
                request_serializer=proxy__pb2.NotifyChannelStateRequest.SerializeToString,
                response_deserializer=proxy__pb2.NotifyChannelStateResponse.FromString,
                _registered_method=True)
...
def add_CentrifugoProxyServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Connect': grpc.unary_unary_rpc_method_handler(
                    servicer.Connect,
                    request_deserializer=proxy__pb2.ConnectRequest.FromString,
                    response_serializer=proxy__pb2.ConnectResponse.SerializeToString,
            ),
            'Refresh': grpc.unary_unary_rpc_method_handler(
                    servicer.Refresh,
                    request_deserializer=proxy__pb2.RefreshRequest.FromString,
                    response_serializer=proxy__pb2.RefreshResponse.SerializeToString,
            ),
            'Subscribe': grpc.unary_unary_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=proxy__pb2.SubscribeRequest.FromString,
                    response_serializer=proxy__pb2.SubscribeResponse.SerializeToString,
            ),
            'Publish': grpc.unary_unary_rpc_method_handler(
                    servicer.Publish,
                    request_deserializer=proxy__pb2.PublishRequest.FromString,
                    response_serializer=proxy__pb2.PublishResponse.SerializeToString,
            ),
            'RPC': grpc.unary_unary_rpc_method_handler(
                    servicer.RPC,
                    request_deserializer=proxy__pb2.RPCRequest.FromString,
                    response_serializer=proxy__pb2.RPCResponse.SerializeToString,
            ),
            'SubRefresh': grpc.unary_unary_rpc_method_handler(
                    servicer.SubRefresh,
                    request_deserializer=proxy__pb2.SubRefreshRequest.FromString,
                    response_serializer=proxy__pb2.SubRefreshResponse.SerializeToString,
            ),
            'SubscribeUnidirectional': grpc.unary_stream_rpc_method_handler(
                    servicer.SubscribeUnidirectional,
                    request_deserializer=proxy__pb2.SubscribeRequest.FromString,
                    response_serializer=proxy__pb2.StreamSubscribeResponse.SerializeToString,
            ),
            'SubscribeBidirectional': grpc.stream_stream_rpc_method_handler(
                    servicer.SubscribeBidirectional,
                    request_deserializer=proxy__pb2.StreamSubscribeRequest.FromString,
                    response_serializer=proxy__pb2.StreamSubscribeResponse.SerializeToString,
            ),
            'NotifyCacheEmpty': grpc.unary_unary_rpc_method_handler(
                    servicer.NotifyCacheEmpty,
                    request_deserializer=proxy__pb2.NotifyCacheEmptyRequest.FromString,
                    response_serializer=proxy__pb2.NotifyCacheEmptyResponse.SerializeToString,
            ),
            'NotifyChannelState': grpc.unary_unary_rpc_method_handler(
                    servicer.NotifyChannelState,
                    request_deserializer=proxy__pb2.NotifyChannelStateRequest.FromString,
                    response_serializer=proxy__pb2.NotifyChannelStateResponse.SerializeToString,
            ),
    }
...
class CentrifugoProxy(object):
    ...
    def Connect(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/Connect',
            proxy__pb2.ConnectRequest.SerializeToString,
            proxy__pb2.ConnectResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Refresh(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/Refresh',
            proxy__pb2.RefreshRequest.SerializeToString,
            proxy__pb2.RefreshResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/Subscribe',
            proxy__pb2.SubscribeRequest.SerializeToString,
            proxy__pb2.SubscribeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Publish(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/Publish',
            proxy__pb2.PublishRequest.SerializeToString,
            proxy__pb2.PublishResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def RPC(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/RPC',
            proxy__pb2.RPCRequest.SerializeToString,
            proxy__pb2.RPCResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SubRefresh(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/SubRefresh',
            proxy__pb2.SubRefreshRequest.SerializeToString,
            proxy__pb2.SubRefreshResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SubscribeUnidirectional(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/SubscribeUnidirectional',
            proxy__pb2.SubscribeRequest.SerializeToString,
            proxy__pb2.StreamSubscribeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SubscribeBidirectional(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/SubscribeBidirectional',
            proxy__pb2.StreamSubscribeRequest.SerializeToString,
            proxy__pb2.StreamSubscribeResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def NotifyCacheEmpty(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/NotifyCacheEmpty',
            proxy__pb2.NotifyCacheEmptyRequest.SerializeToString,
            proxy__pb2.NotifyCacheEmptyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def NotifyChannelState(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/centrifugal.centrifugo.proxy.CentrifugoProxy/NotifyChannelState',
            proxy__pb2.NotifyChannelStateRequest.SerializeToString,
            proxy__pb2.NotifyChannelStateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
